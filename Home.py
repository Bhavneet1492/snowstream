...
st.markdown('<h3 class="custom3"><i>You can see how popular a topic is [Popularity](https://bhavneet1492-snowstream-home-eizpch.streamlit.app/Popularity) and locate institutions on a world map too! [Stream->Location](https://bhavneet1492-snowstream-home-eizpch.streamlit.app/Stream)</i></h3>',unsafe_allow_html=True)
